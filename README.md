...
## 🚀 طريقة التشغيل
1. تغيير التوكن من ملف البوت الأساسي.
2. تثبيت التبعيات:
   ```bash
   npm install
اذهب إلى ديسكورد، استخدم الأمر المخصص لفتح اللوحة، واستمتع!

🌐 روابط مهمة
الاستضافة المجانية: Wispbyte
...
تنبيه للمطورين:
إذا كنت مستني بوت كامل وجاهز، مش مكانك! هذا مشروع بوت بدائي ومفتوح المصدر، عدل زي ما بدك. إذا حبيت تبيع نسختك الخاصة الله يرزقك، وإذا حبيت توزعها تمام.
